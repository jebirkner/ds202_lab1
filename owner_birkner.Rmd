...
1. Owner: Create an `owner_YourName.Rmd` file. Add the following information into the file: 
    ...
    - What do you tell people about your field of study at a party?
        ...
        I tell people advertising is about problem solving and involves many different skills.
        
    - What are the three most important tools/strategies you use for organizing your work?
    
        keep folders seperated by class, sort in alphabetic order, keep all related files in folders on my computer
...
You may work on this with your partner or individually. 
  ...
  Git is a version control system that tracks changes and makes it easy to collaborate with others. Github is an online hosting service.
  
  2. Can Git and Github be used independently? Why don't we do so? Describe the advantages and disadvantages.
  
  Yes. Git and Github can be used independently; however, each is more powerful when used in tandom with the other. Git can track changes to a file and Github makes it easy share a file. They both work together to allow multiple individuals to work on a project.

  3. What is a repository in Git and how can you create a repository in Git (write out the command(s))?
  
  A repository is a storage space where files can live. To create a repository navigate to a directory in the terminal and type git init. Now Git will treat the directory as a repository.
...
#This function gives the proportion of NA values out of the total values in a vector.
     
```

```{r}
Vector_mean = function(x){
  Vector_mean = x / sum(x, na.rm = TRUE)
  return(Vector_mean)
}

#This function calculates the mean of a vector ignoring any NA values. 
...
```{r}
y = c(1,NA,2,3,4,5,6,7,8,9,1,2)

#I created this vector to test my function "both_na" below.
```
